            ...
            <div class="card">
                ...
                <?php
                    if($_SERVER["REQUEST_METHOD"]=="POST"){
                        ...
                        $city = $_POST["kota_nama"];
                        
                        
                        $perintah = "SELECT customerName 
                        FROM customers
                        WHERE city = \"$city\";";
                        ...
                        print("<h5 class=\"text-center\">Data Nama Customer dari Kota $city </h5>");
                        ...
                        print("Terdapat $row pelanggan di kota $city");
